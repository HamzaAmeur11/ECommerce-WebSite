			...
			<div className="px-4 py-3 flexBetween max-xs:px-2">
				...
				<div className="flexBetween sm:gap-x-6 bold-16">
					...
					<div className="flexBetween sm:gap-x-3">
						<NavLink to={'cart-page'} className="flex"><FaOpencart className="w-8 h-8 p-1 rounded-full ring-1 ring-sky-900/30" /><span className="relative w-5 h-5 text-white rounded-full flexCenter bg-secondary medium-15 -top-2">0</span> </NavLink>
